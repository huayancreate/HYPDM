...
{
   /// <summary>
   /// 实体对象 MYWOKSPACE(我的工作区)。
   /// </summary>
   [Serializable()]
   [Table("MYWOKSPACE","我的工作区")]
   partial class MYWOKSPACE: DataEntity<MYWOKSPACE>
   {
       public MYWOKSPACE()
       {
       }
       
       protected MYWOKSPACE(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 父节点ID 。
       /// </summary>
       [Column("PARENTID","父节点ID"),DataSize(128)]
       [DisplayName("父节点ID")]
       ...
       /// 用户ID 。
       /// </summary>
       [Column("USERID","用户ID"),DataSize(128)]
       [DisplayName("用户ID")]
       ...
       /// 能否添加子结构
       /// </summary>
       [Column("ISADDCHILD", "添加子结构")]
       [DisplayName("添加子结构")]
       public int ISADDCHILD
       {
           get;
           set;
       }
