...
{
   /// <summary>
   /// 实体对象 MYWORKRECORD(工作记录)。
   /// </summary>
   [Serializable()]
   [Table("MYWORKRECORD","工作记录")]
   partial class MYWORKRECORD: DataEntity<MYWORKRECORD>
   {
       public MYWORKRECORD()
       {
       }
       
       protected MYWORKRECORD(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 工作流程主键 。
       /// </summary>
       [Column("WORD_ID","工作流程主键"),DataSize(128)]
       [DisplayName("工作流程主键")]
       ...
       /// 步骤主键 。
       /// </summary>
       [Column("STEP_ID", "步骤主键"), DataSize(128)]
       [DisplayName("步骤主键")]
       ...
       /// 用户 。
       /// </summary>
       [Column("USERNAME","用户"),DataSize(128)]
       [DisplayName("用户")]
