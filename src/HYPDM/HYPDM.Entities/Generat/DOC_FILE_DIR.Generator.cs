...
{
   /// <summary>
   /// 实体对象 DOC_FILE_DIR(DOC_FILE_DIR)。
   /// </summary>
   [Serializable()]
   [Table("dbo.DOC_FILE_DIR","DOC_FILE_DIR")]
   partial class DOC_FILE_DIR: DataEntity<DOC_FILE_DIR>, IDataEntity<DOC_FILE_DIR>
   {
       public DOC_FILE_DIR()
       {
       }
       
       protected DOC_FILE_DIR(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// DFD_ID 。
       /// </summary>
       [Column("DFD_ID","DFD_ID"),DataSize(50),PrimaryKey]
       [DisplayName("DFD_ID")]
       public string DFD_ID
       {
           get;
           set;
       }
       ...
       /// DFD_ROOT_DIR 。
       /// </summary>
       [Column("DFD_ROOT_DIR","DFD_ROOT_DIR"),DataSize(200)]
       [DisplayName("DFD_ROOT_DIR")]
       public string DFD_ROOT_DIR
       {
           get;
           set;
       }
       ...
       /// DFD_PATH_NAME 。
       /// </summary>
       [Column("DFD_PATH_NAME","DFD_PATH_NAME"),DataSize(200)]
       [DisplayName("DFD_PATH_NAME")]
       public string DFD_PATH_NAME
       {
           get;
           set;
       }
       ...
       /// DFD_PARENT_DIR_ID 。
       /// </summary>
       [Column("DFD_PARENT_DIR_ID","DFD_PARENT_DIR_ID"),DataSize(50)]
       [DisplayName("DFD_PARENT_DIR_ID")]
       public string DFD_PARENT_DIR_ID
       {
           get;
           set;
       }
