...
{
    /// <summary>
    /// 实体对象 PDM_PRODUCT_DOCUMENT(产品文档)。
    /// </summary>
    [Serializable()]
    [Table("PDM_PRODUCT_DOCUMENT", "产品文档")]
    partial class PDM_PRODUCT_DOCUMENT : DataEntity<PDM_PRODUCT_DOCUMENT>, IDataEntity<PDM_PRODUCT_DOCUMENT>
    {
        public PDM_PRODUCT_DOCUMENT()
        {
        }

        protected PDM_PRODUCT_DOCUMENT(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// 文档ID 。
        /// </summary>
        [Column("DOCUMENTID", "文档ID"), DataSize(128)]
        [DisplayName("文档ID")]
