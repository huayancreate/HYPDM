...
{
   /// <summary>
   /// 实体对象 PDM_PRODUCT_PRORECORD(产品生产记录)。
   /// </summary>
   [Serializable()]
   [Table("PDM_PRODUCT_PRORECORD","产品生产记录")]
   partial class PDM_PRODUCT_PRORECORD: DataEntity<PDM_PRODUCT_PRORECORD>
   {
       public PDM_PRODUCT_PRORECORD()
       {
       }
       
       protected PDM_PRODUCT_PRORECORD(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// PRORECORDID 。
       /// </summary>
       [Column("PRORECORDID","PRORECORDID"),PrimaryKey]
       [DisplayName("PRORECORDID")]
       public long PRORECORDID
       {
           get;
           set;
       }
       ...
       /// PRUDUCTID 。
       /// </summary>
       [Column("PRUDUCTID","PRUDUCTID"),DataSize(128)]
       [DisplayName("PRUDUCTID")]
       public string PRUDUCTID
       {
           get;
           set;
       }
       ...
       /// PRODUCTNUM 。
       /// </summary>
       [Column("PRODUCTNUM","PRODUCTNUM")]
       [DisplayName("PRODUCTNUM")]
       ...
       /// WORKSHOP 。
       /// </summary>
       [Column("WORKSHOP","WORKSHOP"),DataSize(128)]
       ...
       /// WORKSHOPDIRECTOR 。
       /// </summary>
       [Column("WORKSHOPDIRECTOR","WORKSHOPDIRECTOR"),DataSize(128)]
       [DisplayName("WORKSHOPDIRECTOR")]
       public string WORKSHOPDIRECTOR
       {
           get;
           set;
       }
