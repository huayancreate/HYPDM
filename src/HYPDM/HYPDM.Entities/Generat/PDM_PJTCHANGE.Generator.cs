...
{
   /// <summary>
   /// 实体对象 PDM_PJTCHANGE(产品变更记录表)。
   /// </summary>
   [Serializable()]
   [Table("PDM_PJTCHANGE","产品变更记录表")]
   partial class PDM_PJTCHANGE: DataEntity<PDM_PJTCHANGE>
   {
       public PDM_PJTCHANGE()
       {
       }
       
       protected PDM_PJTCHANGE(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 变更编号 。
       /// </summary>
       [Column("PJTCHANGENO","变更编号"),DataSize(128),PrimaryKey]
       [DisplayName("变更编号")]
       public string PJTCHANGENO
       {
           get;
           set;
       }
       ...
       /// 变更时间 。
       /// </summary>
       [Column("CHANGETIME","变更时间"),DataSize(128)]
       [DisplayName("变更时间")]
       ...
       /// 变更状态 。
       /// </summary>
       [Column("CHANGESTATUS","变更状态"),DataSize(128)]
       [DisplayName("变更状态")]
       ...
       /// 变更人 。
       /// </summary>
       [Column("CHANGEPERSON","变更人"),DataSize(128)]
       [DisplayName("变更人")]
       ...
       /// 变更原因 。
       /// </summary>
       [Column("CHANGEREASON","变更原因"),DataSize(128)]
       [DisplayName("变更原因")]
