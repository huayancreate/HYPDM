...
{
   /// <summary>
   /// 实体对象 PDM_PRODUCT_CHANGE(产品与变更记录关系对应)。
   /// </summary>
   [Serializable()]
   [Table("PDM_PRODUCT_CHANGE","产品与变更记录关系对应")]
   partial class PDM_PRODUCT_CHANGE: DataEntity<PDM_PRODUCT_CHANGE>
   {
       public PDM_PRODUCT_CHANGE()
       {
       }
       
       protected PDM_PRODUCT_CHANGE(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 产品编号 。
       /// </summary>
       [Column("PRODUCTNO","产品编号"),DataSize(128)]
       [DisplayName("产品编号")]
       ...
       /// 工程变更编号 。
       /// </summary>
       [Column("PJTCHANGENO","工程变更编号"),DataSize(128)]
       [DisplayName("工程变更编号")]
