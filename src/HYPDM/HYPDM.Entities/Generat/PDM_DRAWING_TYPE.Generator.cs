...
{
   /// <summary>
   /// 实体对象 PDM_DRAWING_TYPE(图纸类型)。
   /// </summary>
   [Serializable()]
   [Table("dbo.PDM_DRAWING_TYPE","图纸类型")]
   partial class PDM_DRAWING_TYPE: DataEntity<PDM_DRAWING_TYPE>, IDataEntity<PDM_DRAWING_TYPE>
   {
       public PDM_DRAWING_TYPE()
       {
       }
       
       protected PDM_DRAWING_TYPE(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 图纸类型ID 。
       /// </summary>
       [Column("ID","图纸类型ID"),DataSize(64),PrimaryKey]
       [DisplayName("图纸类型ID")]
       public string ID
       {
           get;
       ...
       /// 图纸类型名称 。
       /// </summary>
       [Column("NAME","图纸类型名称"),DataSize(128)]
       [DisplayName("图纸类型名称")]
       public string NAME
       {
           get;
