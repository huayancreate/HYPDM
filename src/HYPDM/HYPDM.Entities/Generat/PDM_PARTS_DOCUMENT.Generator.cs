...
{
   /// <summary>
   /// 实体对象 PDM_PARTS_DOCUMENT(半成品文档)。
   /// </summary>
   [Serializable()]
   [Table("PDM_PARTS_DOCUMENT","半成品文档")]
   partial class PDM_PARTS_DOCUMENT: DataEntity<PDM_PARTS_DOCUMENT>, IDataEntity<PDM_PARTS_DOCUMENT>
   {
       public PDM_PARTS_DOCUMENT()
       {
       }
       
       protected PDM_PARTS_DOCUMENT(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 半成品文档 。
       /// </summary>
       [Column("PARTSID","半成品文档"),DataSize(128)]
       [DisplayName("半成品文档")]
