    ...
    public class MaterailService : BaseServiceObject, HYPDM.BLL.IMaterailService
    {
        ...
        public DataTable GetAssoDoc(String p_MaterailId,String p_version) {
            string sqlText = " select b.DOCID, b.DOCNO,b.VERSION,b.DOCSTATUS,b.CREATEUSER "
                                 ...
                                 + " where a.MASTEROBJECTTYPE='Document' and  a.MASTEROBJECTID=b.DOCID and a.DEL_FALG='N' and b.DEL_FLAG = 'N' and a.RELATIONOBJECTTYPE='Material' "
        ...
        public DataTable GetDocList(String p_MaterailId,String p_version ,int p_type,String p_value ) {
            string sqlText = " select b.DOCID,b.DOCNO,b.VERSION,b.CREATEUSER,b.DESCRIPTION "
                                ...
                                + " where  b.DEL_FLAG = 'N'  "
                                + " and b.DOCID not in("
                                + " select a.MASTEROBJECTID from ObjectRelation a where  a.MASTEROBJECTTYPE='Document' and a.DEL_FALG ='N'   and a.RELATIONOBJECTTYPE='Material'  "
	                            + " and a.RELATIONOBJECTID ='"+p_MaterailId+"'  "
                                + " and a.RELATIONOBJECTVERSION ='" + p_version + "'  "
	                             + " )  ";
            if (p_type == 1)
        ...
        public DataTable GetAssoDraw(String p_MaterailId, String p_version)
        {
            string sqlText = " select b.DOCID, b.DOCNO,b.VERSION,b.DOCSTATUS,b.CREATEUSER "
                                 + " from ObjectRelation a, PDM_DRAWING b "
                                 + " where a.MASTEROBJECTID=b.DOCID and a.MASTEROBJECTTYPE='Drawing' and a.DEL_FALG='N' and b.DEL_FLAG = 'N' and a.RELATIONOBJECTTYPE='Material' "
                                 + " and a.RELATIONOBJECTID='" + p_MaterailId + "' "
                                 + " and a.RELATIONOBJECTVERSION='" + p_version + "' ";
            return this.DataAccessor.QueryDataTable(sqlText);
        }

        public void DelAssoDraw(String p_DocId, String p_DocVersion, String p_MaterailId, String p_MaterailVersion)
        {
            string sqlText = " update ObjectRelation set DEL_FALG ='Y'  "
        ...
        public DataTable GetDrawList(String p_MaterailId, String p_version, int p_type, String p_value)
        {
            string sqlText = " select b.DOCID,b.DOCNO,b.VERSION,b.CREATEUSER,b.DESCRIPTION "
                                + " from PDM_DRAWING b  "
                                + " where  b.DEL_FLAG = 'N'  "
                                + " and b.DOCID not in("
                                + " select a.MASTEROBJECTID from ObjectRelation a where  a.MASTEROBJECTTYPE='Drawing' and a.DEL_FALG ='N'   and a.RELATIONOBJECTTYPE='Material'  "
                                + " and a.RELATIONOBJECTID ='" + p_MaterailId + "'  "
                                + " and a.RELATIONOBJECTVERSION ='" + p_version + "'  "
                                 + " )  ";
            if (p_type == 1)
