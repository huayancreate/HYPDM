...
namespace HYPDM.WinUI.ProductsAndParts.Products
{
    public partial class ProductsStructAddForm : Form
    {
        ...
        **************************************************************/
        ...
        //结构体初始化
        public ProductsStructAddForm(HYPDM.Entities.PDM_ALL_PRODUCT t)
        {
            InitializeComponent();
            this.Text = "产品结构添加--" + t.PRODUCTNO;
            this.copy_Product = t;
            tv_struct_init();
            dgv_productList_init();
        ...
        IPartsService _iPartsService = EAS.Services.ServiceContainer.GetService<IPartsService>();
        //列表控件初始化
        private void dgv_productList_init()
        {
            this.dgv_PartsList.DataSource = _iPartsService.GetPartsList();
        }
        //属性列表控件出事化
        ...
        {
            QueryStructForm o = new QueryStructForm();
            o.StartPosition = FormStartPosition.CenterParent;
            if (o.ShowDialog()==DialogResult.OK) {
               // this.dgv_productList = o.Product;
            }
        }
        ...
        private void dgvProductListInit() {
            this.dgv_productList.DataSource = m_structService.GetProductList();
        }
        //产品列表数据选择
        ...
        {
            this.dgv_PartsList.DataSource = m_structService.GetPartsList();
        }
        ...
        {
            this.dgv_MaterialList.DataSource = m_structService.GetMaterailList();
        }
        ...
        private void selectMaterail() {
            ...
            StructAddForm o = new StructAddForm(this.copy_Product.PRODUCTID, t_materailId);
            o.StartPosition = FormStartPosition.CenterParent;
            o.ShowDialog();
        ...
        private void selectParts()
        {
            ...
            StructAddForm o = new StructAddForm(this.copy_Product.PRODUCTID, t_partsId);
            o.StartPosition = FormStartPosition.CenterParent;
            o.ShowDialog();
        ...
        private void selectProduct()
        {
            ...
            StructAddForm o = new StructAddForm(this.copy_Product.PRODUCTID, t_productId);
            o.StartPosition = FormStartPosition.CenterParent;
            o.ShowDialog();
