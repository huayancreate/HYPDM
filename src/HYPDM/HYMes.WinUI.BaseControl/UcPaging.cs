...
{  
    ...
    public partial class UcPaging : UserControl
    {
        ...
        private Boolean exportIsVisiable = true;
        /// <summary>
        /// 设定是否显示汇出功能
        /// </summary>
        public Boolean ExportIsVisiable
        {
            get { return exportIsVisiable; }
            set { exportIsVisiable = value; }
        }
        /// <summary>
        /// dataGridView控件的分页事件
        /// </summary>
        public UcPaging()
        {
            ...
            //if (exportIsVisiable == false)
            //{
            //    tstExport.Visible = false;
            //}
        ...
        {
            //MessageBox.Show(this.ExportIsVisiable.ToString());

            //===========================start add by cs 20130814 新增是否显示汇出功能属性V1.1======================================
            this.tstExport.Visible = this.exportIsVisiable;
            this.toolStripSeparator4.Visible = this.exportIsVisiable;
            //===========================end V1.1===================================================================================
        ...
        private void bdnInfo_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            if (e.ClickedItem.Name == "tstExport") //资料汇出功能Excel
            {
                ...
                if (save.ShowDialog() == DialogResult.OK)
                {
                    ...
                    ExportToExcelProvider.ExportToExcel(pagingData, fileNamePath); //导出所有页面的数据
